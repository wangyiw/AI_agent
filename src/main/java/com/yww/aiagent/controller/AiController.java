package com.yww.aiagent.controller;

import com.yww.aiagent.agent.MyManus;
import com.yww.aiagent.app.TourApp;
...
public class AiController {
    ...
    public Flux<ServerSentEvent<String>> doChatWithTourAppServerSentEvent(String message, String chatId) {
        return tourApp.doChatByStream(message, chatId)
    ...
    public SseEmitter doChatWithTourAppServerSseEmitter(String message, String chatId) {
